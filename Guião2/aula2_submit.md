...
```
As entidades definidas são: Produto, Encomenda, Fornecedor, e Tipo de Fornecedor.

Para a entidade Produto, os atributos incluem: Nome, Código, Stock, Preço, e Taxa de IVA.
Para a entidade Encomenda, são atribuídos os seguintes atributos: Número, Data e fornecedor único.
No que se refere à entidade Fornecedor, os atributos consistem em: Número de Informação Fiscal, Nome, Endereço, FAX, e Condições de Pagamento.
E para a entidade Tipo de Fornecedor, os atributos são: ID e Designação.

Relativamente às relações entre estas entidades, um Produto pode estar incluído em várias Encomendas ou em nenhuma. Um Fornecedor pode fornecer vários Produtos em várias Encomendas ou não fornecer nenhum, além de estar categorizado sob um Tipo de Fornecedor, identificado por um ID e uma Designação. Cada Encomenda deve conter pelo menos um Produto e é associada a um único Fornecedor.
...
```
Relação Produto-Encomenda -> A participação da entidade Encomenda é obrigatória
Relação Encomenda-Fornecedor -> A participação do fornecedor é obrigatória
Relação Fornecedor-Tipo Fornecedor -> A participação da entidade Fornecedor é obrigatória
...
![113765_114614_ex1!](113765_114614_ex1.png "AnImage or PDF file")
...
![113765_114614_ex2!](113765_114614_ex2.png "AnImage or PDF file")
...
![113765_114614_ex3!](113765_114614_ex3.png "AnImage or PDF file")
...
![113765_114614_ex4!](113765_114614_ex4.jpg "AnImage or PDF file")
